...
Runtipi has a wide range of selfhosted apps you can install on your server. You can find them all in the [app store repo](https://github.com/runtipi/runtipi-appstore) and make requests for new apps there.
