...
Tipi is asking for the sudo password in order to give certain file permissions to the user running the dashboard.
If for some reason you don't want to give the sudo password, you can run the script with the `--no-permissions` flag.
