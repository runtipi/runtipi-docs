...
<Callout type="warning">
  Be sure to remove the comments from the example above an that the final content is a valid JSON
  format. You can easily check for validity in an online tool like [JSONLint](https://jsonlint.com/)
</Callout>
