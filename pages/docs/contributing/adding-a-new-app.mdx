...
- The app you want to add should be free and open-source (or at least source available with a permissive license for personal use)
- The app you want to add should have an official and maintained docker image
