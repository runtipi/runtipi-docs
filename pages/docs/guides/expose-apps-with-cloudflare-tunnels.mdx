...
In the Cloudflare dashboard, go to the **Zero Trust** tab and click on **Access** -> **Tunnels**.
<br />
<Image src="/images/cloudflare-tunnels/tunnels-menu.png" width={260} height={300} />
