...
<Callout type="warning">
  ...
  we won't be able to help you. You will probably face issues if the main runtipi config is changed.
</Callout>
...
<Callout>
  Don't edit the `docker-compose.yml` file directly because it will be overwritten on every restart
  of runtipi.
</Callout>
