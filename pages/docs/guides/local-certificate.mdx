...
<Callout>
  Don't forget to add the wildcard domain `*.tipi.lan` to the `DNS rewrites` section in order to be
  able to access your apps as well.
</Callout>
...
<Callout emoji="⚠️" type="warning">
  By using this method you need to do this on every device you want to access your dashboard and
  apps from and for every domain you want to use. (e.g. `tipi.lan`, `app1.tipi.lan`,
  `app2.tipi.lan`)
</Callout>
