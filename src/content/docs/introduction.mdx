...
<Callout emoji="�">
  **New to Runtipi?** Start with our [Quick Start Guide](/docs/quick-start) to get up and running in 10 minutes!
</Callout>
...
<Cards>
  ...
  >
    Get Runtipi running in 10 minutes
  </Cards.Card>
  <Cards.Card
    icon={<LightBulbIcon />}
    title="Learn"
