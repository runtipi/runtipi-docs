...
<Cards>
  ...
  />
  <Cards.Card icon={<LightBulbIcon />} title="Learn" href="/docs/learn" />
  <Cards.Card
    icon={<BookOpenIcon />}
    title="Browse Apps"
...
<Callout type="info">
  These docs are continuously evolving. If you find something unclear or
  missing, please help us improve by
  [contributing](https://github.com/runtipi/runtipi-docs) or providing feedback!
</Callout>
