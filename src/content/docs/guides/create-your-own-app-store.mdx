...
<Callout type="warning">
  This feature is intended for users who are comfortable with GitHub and are willing to maintain and share their own app store. If you just want to install apps for yourself, we recommend using the "create custom app" feature instead.
</Callout>
...
<Callout type="info">
  The schema will help you validate that your `docker-compose.json` file is correct.
</Callout>
