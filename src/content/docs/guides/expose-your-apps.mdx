...
<Callout type="warning">
  Exposing your apps will make them accessible from the internet. Make sure you
  understand the security implications of doing so. Runtipi is not responsible
  for any security breach that could happen on your server resulting from
  exposing your apps.
</Callout>
<Callout type="warning">
  Also be aware that opening ports 80 or 443 on your router can expose your
  network to security risks. If someone knows your public IP address (which is
  easy to find by looking up your domain) they will be able to access your
  Runtipi login page. Make sure you have a strong password and use 2FA to secure
  your Runtipi instance.
</Callout>
