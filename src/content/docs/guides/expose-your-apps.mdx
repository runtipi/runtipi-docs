...
- **Prerequisites:** Domain name, router access

<Callout type="info">
  **New to networking concepts?** Read our [Networking & Reverse Proxy guide](/docs/learn/core-concepts/networking) first to understand the basics.
</Callout>
...
<Callout type="warning">
  ...
  happen on your server resulting from exposing your apps. A more secure way is to expose your apps
  through a [Cloudflare Tunnel](/docs/guides/expose-apps-with-cloudflare-tunnels).
</Callout>
...
<br />
<Image
  src="/images/expose-your-apps/expose-settings.png"
...
import { CloudIcon, ShieldCheckIcon, GlobeAltIcon } from "@heroicons/react/24/outline";
...
<Cards>
  ...
  <Cards.Card
    ...
    title="DNS Challenge with Cloudflare"
