...
For each app you have installed, run the following commands:

```bash
mv migration-backups/apps/<app-name> apps/migrated/migrated/<app-name>
mv migration-backups/app-data/<app-name> app-data/migrated/migrated/<app-name>
mv migration-backups/user-config/<app-name> user-config/migrated/migrated/<app-name>
mv migration-backups/backups/<app-name> backups/migrated/migrated/<app-name>
```
