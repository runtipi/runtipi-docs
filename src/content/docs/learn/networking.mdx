...
One of the most challenging aspects of self-hosting is networking. This guide breaks down the concepts in plain English so you can make informed decisions about exposing your apps.
...
<Callout type="warning">
  If you run on a VPS or cloud server, "local network" means anyone who can access that server over the internet.
</Callout>
...
<Callout type="info">
  This is the most secure way to access your apps remotely. Consider using Tailscale or WireGuard for easy VPN setup.
</Callout>
