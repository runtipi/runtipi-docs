...
Runtipi is an open source homeserver manager that enables you to run and control multiple services on a single server.
...
a simple, yet powerful tool that enables everyone to host their own services.
